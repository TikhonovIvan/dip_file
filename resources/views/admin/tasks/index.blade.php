                    ...
                    <table class="table align-middle mb-0 bg-white table-striped ">
                        ...
                        @forelse($tasks as $task)
                            <tr>
                                ...
                                <td>
                                    <p class="fw-normal mb-1">{{$task->user->department->name  }}</p>
                                </td>
                                <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Если вы удалить задачу, то все документы относящиеся к этой
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post"
                                                            ...
                                                            <span id="countdownText-{{ $task->id }}"
                                                                  class="text-muted small">Ожидайте... 15 сек</span>
                                                            <button class="btn btn-danger"
                                                                    id="confirmDeleteBtn-{{ $task->id }}" disabled>
                                                                Удалить задачу
                                                            </button>
                                                        </form>
                                                    </div>
